package com.fizzikgames.fizlib.pathfinding;

import java.util.ArrayList;

import com.fizzikgames.fizlib.util.BinaryHeap;
...
public class Astar implements Runnable {
	...
	public Path findPath(Mover mover, Node aStartNode, Node aDestNode) {
		...
		while (openList.getSize() > 0) {
			...
			Node currentNode = (Node) openList.pop(); //Remove lowest cost node, make it current node
